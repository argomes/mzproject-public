...
export interface ApiContributionsTypeContributionsType
  ...
  attributes: {
    description: Schema.Attribute.String & Schema.Attribute.Unique;
...
export interface ApiDdiDdi extends Struct.CollectionTypeSchema {
  collectionName: 'ddis';
  info: {
    singularName: 'ddi';
    pluralName: 'ddis';
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::ddi.ddi'>;
  };
}
...
export interface ApiMemberMember extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    validate_date: Schema.Attribute.DateTime;
    birth_date: Schema.Attribute.Date;
    provider: Schema.Attribute.String;
    profile_picture: Schema.Attribute.Media<'images'>;
    is_active: Schema.Attribute.Boolean;
    contributions_type: Schema.Attribute.Relation<
      'oneToOne',
      'api::contributions-type.contributions-type'
    >;
...
export interface ApiSaleSale extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    description: Schema.Attribute.String;
    is_active: Schema.Attribute.Boolean;
    qnt_month: Schema.Attribute.Integer;
    amout: Schema.Attribute.Decimal;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
